    ...
    return (
        <>
            <Menu pointing secondary className='menubar'>
                ...
                <Menu.Item as={NavLink} to='/overview' content='Overview' className='menu-item' />
                <Menu.Item as={NavLink} to='/bots' content='Bots' className='menu-item' />
